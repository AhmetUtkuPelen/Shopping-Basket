...
function addCart(urun){
    ...
    <div class='d-flex align-items-center gap-2'>
            ...
            <p class="m-0" onclick=sil(${urun.id}) >Delete</p>
        ...
        function arttir(id){
            ...
            let urunler = JSON.parse(localStorage.getItem('basket'))
    ...
    localStorage.setItem('basket',JSON.stringify(urunler))
...
function azalt(id){
    ...
    if(azalt > 1){
        ...
        localStorage.setItem('basket',JSON.stringify(guncelHal))
